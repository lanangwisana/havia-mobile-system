  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300 pb-32">
      <div className="space-y-1.5">
        <label className="text-[0.625rem] font-bold text-neutral-400 ml-1 uppercase tracking-widest">Event Title</label>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          <label className="text-[0.625rem] font-bold text-neutral-400 ml-1 uppercase tracking-widest">Date</label>
        ...
        <div className="space-y-1.5">
          <label className="text-[0.625rem] font-bold text-neutral-400 ml-1 uppercase tracking-widest">Time</label>
      ...
      <div className="space-y-1.5">
        <label className="text-[0.625rem] font-bold text-neutral-400 ml-1 uppercase tracking-widest">Location</label>
      ...
      <div className="space-y-1.5">
        <label className="text-[0.625rem] font-bold text-neutral-400 ml-1 uppercase tracking-widest">Select Label Color</label>
