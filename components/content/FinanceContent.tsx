...
import { TrendingDown, Receipt, DollarSign, Tag, Briefcase, Wallet, PieChart, TrendingUp } from 'lucide-react';
      ...
      {activeTab === 'overview' ? (
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between px-1 pt-2">
            <h3 className="text-sm font-bold text-neutral-900 tracking-wide">Detailed Expense List</h3>
            <span style={{ color: colors.gold }} className="text-[10px] font-bold uppercase tracking-widest">{expenses.length} Items</span>
          </div>

          {isLoadingExpenses ? (
            <LoadingState msg="Loading Expenses..." />
          ) : expenses.length > 0 ? (
                    ...
                    <div className="p-4 pl-5">
                      <div className="flex justify-between items-start mb-3">
                        <div className="flex items-center gap-2">
                          <div className="w-9 h-9 rounded-xl bg-neutral-50 border border-neutral-100 flex items-center justify-center group-hover:bg-[#C69C3D]/10 group-hover:border-[#C69C3D]/20 transition-colors">
                            <TrendingDown className="w-4 h-4 text-neutral-400 group-hover:text-[#C69C3D]" />
                          </div>
                          <div>
